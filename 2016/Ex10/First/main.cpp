...
public:
    ...
    void action(std::vector<Bot> & l_botList)
    {
    ...
    void addValue(int p_value)
    {
        ...
        if (m_lowValue == 17 && m_highValue == 61)
        {
            g_botNumber = m_botIndex;
        }
    }
...
int main()
{
    ...
    std::cout << "Bot number = " << g_botNumber << std::endl;
    return 0;
}
