...
constexpr auto groupEnd = '}';
constexpr auto garbageStart = '<';
constexpr auto garbageEnd = '>';
...
int main()
{
    auto groupLevel = 0;
    auto totalScore = 0;
    auto isGarbage = false;
    auto nonCanceledGarbage = 0;
    ...
    std::cout << "Non canceled garbage = " << nonCanceledGarbage << std::endl;
    return 0;
}
...
group or garbage. Since groups can contain other groups, a } only closes the most-recently-opened unclosed group - that is,
they are nestable. Your puzzle input represents a single, large group which itself contains many smaller ones.
